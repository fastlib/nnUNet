...
from nnunetv2.models.mamba import get_umamba_enc_2d_from_plans, get_transformerunet_from_plans

class nnUNetTransformerTrainer(nnUNetWithClassificationTrainer):
    ...
    def build_network_architecture(architecture_class_name: str,
        ...
        model = get_transformerunet_from_plans(architecture_class_name, arch_init_kwargs, arch_init_kwargs_req_import, num_input_channels, num_output_channels, enable_deep_supervision)
